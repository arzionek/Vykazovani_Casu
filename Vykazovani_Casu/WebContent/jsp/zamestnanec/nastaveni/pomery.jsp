...
<div id="hlavni">
  ...
  <table>
    ...
    <c:if test="${error4 == true}" ><tr><td class="hlaska_chyba">Musí být zadáno kladné číslo!</td></tr></c:if>
  ...
  <table>
    ...
    <tr><td style="width: 160px;"><b>*Velikost úvazku:</b></td><td><input type="text" required="true" name="velikost" value="${objekt.velikostUvazku}" <c:if test="${error2 == true || error4 == true}">class="povinne"</c:if>/></td></tr>
    <tr><td>&nbsp</td></tr>
