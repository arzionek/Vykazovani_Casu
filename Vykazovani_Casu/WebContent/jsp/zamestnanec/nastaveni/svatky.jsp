...
<div id="hlavni">
  ...
  <table>
    ...
    <c:if test="${error0 == true}" ><tr><td class="hlaska_chyba">Údaj se stejným kódem, názvem nebo datem již existuje!</td></tr></c:if> 
  ...
  <table>
    ...
    <tr><td style="width: 100px;"><b>*Datum:</b></td><td><input type="text" required="true" name="datum" id="datepicker" value="${objekt.datum2}" <c:if test="${error0 == true || error3 == true}">class="povinne"</c:if>/></td></tr>
    <tr><td>&nbsp;</td></tr>
