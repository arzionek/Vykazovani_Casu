...
<div id="hlavni">
  ...
  <div class="box">
  <table>
    <c:if test="${objekt.id != -1}"><tr><td class="zvyraznit2">Upravit činnost:</td></tr></c:if>
    <c:if test="${objekt.id == -1}"><tr><td class="zvyraznit2">Nová činnost:</td></tr></c:if>
