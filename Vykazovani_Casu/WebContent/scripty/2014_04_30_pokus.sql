...
create table kalendar (kalendar_id bigint not null auto_increment, datum_importu datetime not null, kalendar_definice_id bigint, uzivatel_id bigint, data blob not null, primary key (kalendar_id)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;
...
create table sablona_vykaz (sablona_vykaz_id bigint not null auto_increment, kod varchar(10) not null, nazev varchar(64) not null, typ varchar(255) not null, data blob not null, uzivatel_id bigint, primary key (sablona_vykaz_id)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;
