...
create table cinnost (cinnost_id bigint not null auto_increment, uzivatel_id bigint, kod varchar(10) not null, nazev varchar(128) not null, primary key (cinnost_id));
create table kalendar (kalendar_id bigint not null auto_increment, datum_importu datetime not null, kalendar_definice_id bigint, uzivatel_id bigint, primary key (kalendar_id));
create table kalendar_cinnost (kalendar_cinnost_id bigint not null auto_increment, datum datetime not null, pocet_hodin double precision not null, cinnost_id bigint, pracovni_pomer_id bigint, uzivatel_id bigint, kalendar_id bigint, cas_od datetime not null, cas_do datetime not null, primary key (kalendar_cinnost_id));
create table kalendar_definice (kalendar_definice_id bigint not null auto_increment, kod varchar(10) not null, nazev varchar(64) not null, tag_pracovni_pomer varchar(32) not null, tag_kalendar_cinnost varchar(32) not null, uzivatel_id bigint, primary key (kalendar_definice_id));
create table nastaveni_systemu (nastaveni_systemu_id bigint not null auto_increment, nazev varchar(128) not null, hodnota varchar(128) not null, uzivatel_id bigint, primary key (nastaveni_systemu_id));
create table pracovni_pomer (pracovni_pomer_id bigint not null auto_increment, kod varchar(10) not null, nazev varchar(128) not null, velikost_uvazku double precision not null, uzivatel_id bigint, primary key (pracovni_pomer_id));
create table sablona_vykaz (sablona_vykaz_id bigint not null auto_increment, kod varchar(10) not null, nazev varchar(64) not null, typ integer not null, data blob not null, uzivatel_id bigint, primary key (sablona_vykaz_id));
create table svatek (svatek_id bigint not null auto_increment, datum datetime not null, nazev varchar(64) not null, uzivatel_id bigint, kod varchar(10) not null, primary key (svatek_id));
create table systemova_informace (systemova_informace_id bigint not null auto_increment, datum datetime not null, nadpis varchar(64) not null, data text not null, primary key (systemova_informace_id));
create table tb_pracovni_pomer_sablona_vykaz (pracovni_pomer_id bigint not null, sablona_vykaz_id bigint not null, primary key (pracovni_pomer_id, sablona_vykaz_id));
create table uzivatel (uzivatel_id bigint not null auto_increment, jmeno varchar(32) not null, prijmeni varchar(64) not null, titul_pred varchar(32), titul_za varchar(32), login varchar(32) not null, heslo varchar(64) not null, primary key (uzivatel_id));
