...
create table kalendar (kalendar_id bigint not null auto_increment, datum_importu datetime not null, kalendar_definice_id bigint, uzivatel_id bigint, data mediumblob not null, primary key (kalendar_id)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;
create table kalendar_cinnost (kalendar_cinnost_id bigint not null auto_increment, datum datetime not null, pocet_hodin double precision not null, cinnost_id bigint, pracovni_pomer_id bigint, uzivatel_id bigint, kalendar_id bigint, cas_od datetime not null, cas_do datetime not null, popis text, google_id varchar(255), primary key (kalendar_cinnost_id)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;
create table kalendar_definice (kalendar_definice_id bigint not null auto_increment, kod varchar(10) not null, nazev varchar(64) not null, tag_pracovni_pomer varchar(32) not null, tag_kalendar_cinnost varchar(32) not null, uzivatel_id bigint, tag_popis varchar(255), primary key (kalendar_definice_id)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;
...
create table pracovni_pomer (pracovni_pomer_id bigint not null auto_increment, kod varchar(10) not null, nazev varchar(128) not null, velikost_uvazku double precision not null, uzivatel_id bigint, typ_uvazku varchar(64) not null, primary key (pracovni_pomer_id)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;
create table sablona_vykaz (sablona_vykaz_id bigint not null auto_increment, kod varchar(10) not null, nazev varchar(64) not null, typ varchar(255) not null, data mediumblob not null, uzivatel_id bigint, primary key (sablona_vykaz_id)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;
...
create table tb_pracovni_pomer_sablona_vykaz (pracovni_pomer_id bigint not null, sablona_vykaz_id bigint not null, primary key (sablona_vykaz_id, pracovni_pomer_id)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;
