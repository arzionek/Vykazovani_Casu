...
create table kalendar_definice (kalendar_definice_id bigint not null auto_increment, kod varchar(10) not null, nazev varchar(64) not null, tag_pracovni_pomer varchar(32) not null, tag_kalendar_cinnost varchar(32) not null, uzivatel_id bigint, tag_popis varchar(32), primary key (kalendar_definice_id)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;
