...
create table kalendar (kalendar_id bigint not null auto_increment, datum_importu datetime not null, kalendar_definice_id bigint, uzivatel_id bigint, data mediumblob not null, google_id varchar(255), primary key (kalendar_id)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;
create table kalendar_cinnost (kalendar_cinnost_id bigint not null auto_increment, datum datetime not null, pocet_hodin double precision not null, cinnost_id bigint, pracovni_pomer_id bigint, uzivatel_id bigint, kalendar_id bigint, cas_od datetime not null, cas_do datetime not null, popis text, primary key (kalendar_cinnost_id)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;
