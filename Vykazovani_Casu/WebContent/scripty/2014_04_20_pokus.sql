...
create table uzivatel (uzivatel_id bigint not null auto_increment, jmeno varchar(32) not null, prijmeni varchar(64) not null, titul_pred varchar(32), titul_za varchar(32), login varchar(32) not null, heslo varchar(64) not null, primary key (uzivatel_id)) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;
