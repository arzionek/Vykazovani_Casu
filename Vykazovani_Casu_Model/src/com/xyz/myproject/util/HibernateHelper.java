package com.xyz.myproject.util;
...
public class HibernateHelper {
   ...
   */
	public org.hibernate.cfg.Configuration getConfiguration()
        ...
        config.addClass(com.xyz.myproject.model.Uzivatel.class);
        config.addClass(com.xyz.myproject.model.Cinnost.class);
        config.addClass(com.xyz.myproject.model.KalendarCinnost.class);
        config.addClass(com.xyz.myproject.model.SystemovaInformace.class);
        config.addClass(com.xyz.myproject.model.PracovniPomer.class);
        config.addClass(com.xyz.myproject.model.SablonaVykaz.class);
        config.addClass(com.xyz.myproject.model.Svatek.class);
        config.addClass(com.xyz.myproject.model.Kalendar.class);
        config.addClass(com.xyz.myproject.model.KalendarDefinice.class);
        config.addClass(com.xyz.myproject.model.NastaveniSystemu.class);
        return config;
      }
